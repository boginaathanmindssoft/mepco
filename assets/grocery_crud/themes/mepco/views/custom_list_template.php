...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="mDiv">
		<div class="ftitle page-subject-title">
			&nbsp; <?php echo $subject; ?>
		</div>
	...
	<div class="tDiv">
		...
		<?php if($subject == "Category"){
			$splitURL = explode("/", base_url(uri_string()));
			$slug = end($splitURL);
			?>
			<div class="link-button tDiv2">
				<a class="<?php echo $active = ($slug == 'product')?'active':''; ?>" href="<?php echo site_url("admin/category")."/product"; ?>">
					Products
				</a>
				|
				<a class = "<?php echo $active = ($slug == 'application')?'active':''; ?>"href="<?php echo site_url("admin/category")."/application"; ?>">
					Applications
				</a>
			</div>
			<?php
		...
		<?php if(!$unset_add){?>
		<div class="add-button tDiv2">



        	<a href='<?php echo $add_url?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject; ?>' class='add-anchor add_button'>
			<div class="btn btn-success dropdown-toggle waves-effect waves-light">
				<div>
					<span class="add"><?php echo $this->l('list_add'); ?> <?php
					//echo $subject?></span>
				</div>
			</div>
            </a>
	...
	<div class="sDiv quickSearchBox" id='quickSearchBox'>
		<div class="sDiv2">
			...
			<select name="search_field" id="search_field" style="display: none;">
				<option selected="selected" value=""><?php echo $this->l('list_search_all');?></option>
				<?php /*foreach($columns as $column){?>
				<option value="<?php echo $column->field_name?>"><?php echo $column->display_as; ?>&nbsp;&nbsp;</option>
				<?php }*/?>
			</select>
            <input type="button" value="<?php echo $this->l('list_search');?>" class="btn btn-success dropdown-toggle waves-effect waves-light crud_search" id='crud_search'>
		</div>
        <div class='search-div-clear-button'>
        	<input type="button" value="<?php echo $this->l('list_clear_filtering');?>" id='search_clear' class="search_clear btn btn-success dropdown-toggle waves-effect waves-light">
        </div>
	</div>
	<div class="pDiv">
		<div class="pDiv2">
