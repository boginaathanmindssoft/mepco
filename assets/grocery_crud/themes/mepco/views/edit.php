...
if($subject == "Gallery"){
	...
	<div id="gallery-image-preview-field">
	<div class="mDiv" >
		<div class="ftitle">
			<div class="ftitle-left">
				Gallery Images			</div>
	...
	<div class="container form-div">
		<div id="clone_image_preview">
			<li class="cloneLi" style="display: none;">
				<div class="clonedivv">
					<img class="cloneImg"/>
					<a class="data_img_id" onclick="delete_click(this)" href="javascript:void(0);" data-img="">
						Delete
					</a>
				</div>
			</li>
...
<script>
	...
	var action_page = "edit";
	var active_page = "<?php echo $subject; ?>";
