				...
				<div class='tools'>
					<?php if(!$unset_delete){?>
                    	<a href='<?php echo $row->delete_url?>' title='<?php echo $this->l('list_delete')?> <?php echo $subject?>' class="delete-row" >
                    			...
                    			<i class="fa fa-times text-danger c-pointer delete-icon" data-toggle="tooltip" style="" title="" data-original-title="Click here to Edit"></i>
                    	</a>
                    <?php }?>
                    <?php if(!$unset_edit){?>
						<a href='<?php echo $row->edit_url?>' title='<?php echo $this->l('list_edit')?> <?php echo $subject?>' class="edit_button">
							<!-- <span class='edit-icon'></span> -->
								<i class="fa edit-icon fa-pencil text-primary c-pointer" data-toggle="tooltip" style="" title="" data-original-title="Click here to Edit"></i>
